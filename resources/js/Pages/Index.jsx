...
const Home = () => {
  return (
    <>
      <section className="min-h-[100vh] lg:max-h-[100vh] lf:overflow-hidden linear relative text-gray-600 dark:text-gray-100 py-8">
          <div className="bg-gray-800 p-8 lg:px-16 min-h-[500px] lg:h-[500px]  max-w-[90%] rounded-xl shadow-2xl shadow-black flex flex-col justify-between mx-auto my-auto">
            ...
            <div className='grid grid-cols-1 lg:grid-cols-3 mt-16 gap-16 lg:gap-8 p-8 px-0'>
              ...
              <div className='lg:col-span-2 flex flex-col gap-2 lg:pr-8'>
                <div className="flex flex-col gap-4">
                  <h1 className='font-bold'>Bonjour, c'est moi</h1>
                  <h2 className='font-bold text-2xl'>Yendoukoa NADJIRE</h2>
                ...
                <div className="py-8">
                  <Link as='button' className='p-2 px-6 bg-cyan-500 rounded-full text-gray-600 font-semibold shadow-sm hover:shadow-lg hover:shadow-cyan-400'>Télécharger le CV</Link>
                </div>
              </div>
            </div>
          </div>
